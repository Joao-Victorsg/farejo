...
export const editorial = {
  ...
  platforms: { eyebrow: "AS FONTES QUE COMPARAMOS", title: "Plataformas de cashback", description: "Reunimos o cashback dessas plataformas em cada loja. Aqui está o panorama de cada uma — cashback médio por loja, pico e em quantas lojas aparece. Números do Inter marcados como Para correntistas valem só para quem tem conta." },

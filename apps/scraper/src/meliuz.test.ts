...
describe("parseMeliuzStorePage", () => {
  ...
  it("reports no_cashback for a coupon-only page with hero-sec but without ld+json Store", () => {
    const html = '<html><head><link rel="canonical" href="https://www.meliuz.com.br/desconto/cupom-bebrasil"></head><body><h1>Cupom BeBrasil de Julho 2026</h1><div class="hero-sec"></div></body></html>';
    expect(parseMeliuzStorePage(html, "cupom-bebrasil")).toEqual({ slug: "cupom-bebrasil", outcome: "no_cashback" });
  });

...
5. Configurar o GitHub Environment `logos` (secrets `FAREJO_LOGO_WRITER_DATABASE_URL`, `FAREJO_LOGO_S3_*`) quando o projeto hospedado estiver pronto; é melhoria operacional, mesmo padrão do item 3 — não bloqueia o ingestor já implementado (F3/T15).
